...
if __name__ == "__main__":
    ...
    # Remove the database file so the script always starts fresh
    if db_file.exists():
        db_file.unlink()
    ...
    # Create the tables before inserting any data
    ...
    mse800_id = courses.add(
        mse_program_id, "Professional Software Engineering", "2025-11-17", "2026-03-01", "MSE800"
    )
    mse801_id = courses.add(
        mse_program_id, "Research Methods", "2025-11-17", "2026-03-01", "MSE801"
    )
